...
started_at: "2026-01-24T10:47:52Z"
---
...
You are working on this project.
  ...
  4. Read features/dose-tracking/prd.json and find the first story with passes: false
  ...
  WHEN STORY COMPLETE:
  1. Update features/dose-tracking/prd.json - set passes: true
  2. Append to features/dose-tracking/progress.txt with format:
     ---
     Story: [ID] [Title]
  ...
  1. Update FEATURES.md (if it exists):
     - Find the line with this feature name (dose-tracking)
