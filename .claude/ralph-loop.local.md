...
started_at: "2026-01-24T00:48:49Z"
---
...
You are working on this project.
  ...
  4. Read features/settings/prd.json and find the first story with passes: false
  ...
  WHEN STORY COMPLETE:
  1. Update features/settings/prd.json - set passes: true
  2. Append to features/settings/progress.txt with format:
     ---
     Story: [ID] [Title]
  ...
  1. Update FEATURES.md (if it exists):
     - Find the line with this feature name (settings)
