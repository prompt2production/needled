...
started_at: "2026-01-23T13:59:31Z"
---
...
You are working on this project.
  ...
  4. Read features/desktop-layout/prd.json and find the first story with passes: false
  ...
  WHEN STORY COMPLETE:
  1. Update features/desktop-layout/prd.json - set passes: true
  2. Append to features/desktop-layout/progress.txt with format:
     ---
     Story: [ID] [Title]
  ...
  1. Update FEATURES.md (if it exists):
     - Find the line with this feature name (desktop-layout)
