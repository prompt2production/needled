...
started_at: "2026-01-24T00:04:34Z"
---
...
You are working on this project.
  ...
  4. Read features/notifications/prd.json and find the first story with passes: false
  ...
  WHEN STORY COMPLETE:
  1. Update features/notifications/prd.json - set passes: true
  2. Append to features/notifications/progress.txt with format:
     ---
     Story: [ID] [Title]
  ...
  1. Update FEATURES.md (if it exists):
     - Find the line with this feature name (notifications)
