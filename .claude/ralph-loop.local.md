...
started_at: "2026-01-23T15:41:12Z"
---
...
You are working on this project.
  ...
  4. Read features/daily-habits/prd.json and find the first story with passes: false
  ...
  WHEN STORY COMPLETE:
  1. Update features/daily-habits/prd.json - set passes: true
  2. Append to features/daily-habits/progress.txt with format:
     ---
     Story: [ID] [Title]
  ...
  1. Update FEATURES.md (if it exists):
     - Find the line with this feature name (daily-habits)
