...
started_at: "2026-01-23T11:21:01Z"
---
...
You are working on this project.
  ...
  4. Read features/user-onboarding/prd.json and find the first story with passes: false
  ...
  WHEN STORY COMPLETE:
  1. Update features/user-onboarding/prd.json - set passes: true
  2. Append to features/user-onboarding/progress.txt with format:
     ---
     Story: [ID] [Title]
  ...
  1. Update FEATURES.md (if it exists):
     - Find the line with this feature name (user-onboarding)
