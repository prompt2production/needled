interface WeighInReminderParams {
  userName: string
  unsubscribeUrl: string
}

export function renderWeighInReminder({ userName, unsubscribeUrl }: WeighInReminderParams): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="background-color: #0F0F0F; border-radius: 16px; padding: 32px;">
              ...
              <p style="color: #737373; font-size: 16px; line-height: 24px; margin: 0 0 24px 0;">
                Hey ${userName}, it's weigh-in day! Jump on the scale and log your progress to see how far you've come.
              </p>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                <tr>
                  <td style="background-color: #BFFF00; border-radius: 8px;">
                    <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/weigh-in"
          ...
          <tr>
            <td align="center" style="padding-top: 32px;">
              <p style="color: #737373; font-size: 12px; margin: 0;">
                You're receiving this because you signed up for weigh-in reminders on Needled.
              </p>
...
export function getWeighInReminderSubject(): string {
